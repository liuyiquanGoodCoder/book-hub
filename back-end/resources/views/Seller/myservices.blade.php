          ...
          <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Pay For it</a>
                      </td>
                    </tr>
                    </tbody>
                  </table>
              ...
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">View All Services</a>
              </div>
              <!-- /.card-footer -->
            </div>
          </div>
